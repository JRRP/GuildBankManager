...
- Added a cleaner panel-based UI.
...
- Confirmation timeout now reconciles and replans before stopping.
...
- A non-matching item is moved only when it occupies a configured target slot that GBM needs to stock.
